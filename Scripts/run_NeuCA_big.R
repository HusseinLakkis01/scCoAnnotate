...
#############################################################################
  ...
  write.csv(Pred_Labels_NeuCA,paste0(OutputDir,'/NeuCA_big_pred.csv'),row.names = FALSE)
  write.csv(Total_Time_NeuCA,paste0(OutputDir,'/NeuCA_big_total_time.csv'),row.names = FALSE)
}
