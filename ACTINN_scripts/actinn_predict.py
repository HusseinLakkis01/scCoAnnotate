...
def get_parser(parser=None):
	...
	parser.add_argument("-op", "--output_probability", type=bool, help="Output the probabilities for each cell being the cell types in the training data (default: False)", default=True)
...
if __name__ == '__main__':
	...
	print("# Training cells:", train_label.shape[0])
	...
	tr_time.to_csv("ACTINN_training_time.csv", index = False)
	ts_time.to_csv("ACTINN_test_time.csv", index = False)
	predicted_label = []
